...
const PostQuestinerSheet = ({sheetRef, item = {}, onClose}) => {
  ...
  const {isPending, error, data} = useQuery({
    ...
    queryFn: () =>
      getRequest(
        `${APIS.GET_QUESTINER_LIST}?limit=0&page =1&searchText=&questionFor=POST-SLEEP`,
      ),
  });
...
export default PostQuestinerSheet;
